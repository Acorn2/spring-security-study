...
public interface RedisService {
   ...
   * 获取Set结构.
   */
  Set<Object> seMembers(String key);

  /**
   * 向Set结构中添加属性.
   */
  Long seAdd(String key, Object... values);

  /**
   * 向Set结构中添加属性.
   */
  Long seAdd(String key, long time, Object... values);

  /**
   * 是否为Set中的属性.
   */
  Boolean seIsMember(String key, Object value);

  /**
   * 获取Set结构的长度.
   */
  Long seSize(String key);

  /**
   * 删除Set结构中的属性.
   */
  Long seRemove(String key, Object... values);
